...
-rans3p_ksp_type gmres -rans3p_pc_type hypre -rans3p_pc_hypre_type boomeramg -rans3p_ksp_max_it 2000			
...
-pinit_ksp_type   gmres -pinit_pc_type   hypre -pinit_pc_hypre_type    boomeramg -pinit_ksp_gmres_restart 300 -pinit_ksp_knoll -pinit_ksp_max_it 2000
-pressure_ksp_type   gmres -pressure_pc_type   hypre -pressure_pc_hypre_type    boomeramg -pressure_ksp_gmres_restart 300 -pressure_ksp_knoll -pressure_ksp_max_it 2000
